...
var ParticlesBg = function (_Component) {
  ...
  createClass(ParticlesBg, [{
    ...
    value: function getRandom() {
      ...
      if (!this.rand) {
        this.rand = new Rand();
        this.rand.set(0.25, React__default.createElement(Color, { num: num, bg: bg, color: color }));
        this.rand.set(0.2, React__default.createElement(Ball, { num: num, bg: bg, color: color }));
        this.rand.set(0.2, React__default.createElement(Lines, { num: num, bg: bg, color: color }));
        this.rand.set(0.16, React__default.createElement(Thick, { num: num, bg: bg, color: color }));
        this.rand.set(0.18, React__default.createElement(Circle, { num: num, bg: bg, color: color }));
        this.rand.set(0.04, React__default.createElement(Cobweb, { num: num, bg: bg, color: color }));
        this.rand.set(0.1, React__default.createElement(Polygon, { num: num, bg: bg, color: color }));
        this.rand.set(0.08, React__default.createElement(Square, { num: num, bg: bg, color: color }));
        this.rand.set(0.18, React__default.createElement(Tadpole, { num: num, bg: bg, color: color }));
        this.rand.set(0.15, React__default.createElement(Fountain, { num: num, bg: bg, color: color }));
      }
